...
public class Class {
    ...
    public void addMethod(Type returnType, String methodName, HashMap<String, Models.Type> args,
            HashMap<Integer, String> argorder) throws DuplicatedMethodNameError {
        if (methods.containsKey(methodName))
            throw new DuplicatedMethodNameError(methodName, name);
        Method method = new Method(methodName, returnType, args, argorder, this);
    ...
    public Method getMethod(String methodName) throws MethodNotFoundError {
